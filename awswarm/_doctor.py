"""Stack-aware `doctor` for awswarm.
...
interesting failures live BETWEEN them. "awswarm is installed" is not the useful
fact -- "awswarm is installed and the thing it pairs with is not" is. This reports
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awswarm needs at runtime, and a
